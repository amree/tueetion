...
class QuantityFeeEnrollTest < ActiveSupport::TestCase
  ...
  test "should be invalidate with no enrollable" do
  ...
  test "should be invalidate with invalid enrollable" do
    enroll = QuantityFeeEnroll.new
    enroll.student = @center.students.first
  ...
  test "should be invalidate with other's quantity fee" do
